...
public class AcceptedRequests extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.acceptedreq);
    ...
    protected void onStart() {
        ...
        context = AcceptedRequests.this;
        datasource = new ArrayList<>();
        listView = findViewById(R.id.donerlist);

        databaseReference = FirebaseDatabase.getInstance().getReference().child("Userdata").child(FirebaseAuth.getInstance().getUid()).child("AcceptedRequests");
